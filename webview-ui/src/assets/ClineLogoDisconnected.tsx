	...
	<svg fill="none" height="50" viewBox="0 0 47 50" width="47" xmlns="http://www.w3.org/2000/svg" {...props}>
		<defs>
			<mask id="eye-mask">
				...
				<rect fill="white" height="50" width="47" x="0" y="0" />
				{/* Draw the 'X's in black to "cut them out" (make them transparent) */}
				<path d="M12.5 23 L 19.5 34 M 19.5 23 L 12.5 34" stroke="black" strokeLinecap="round" strokeWidth="2.5" />
				<path d="M27.5 23 L 34.5 34 M 34.5 23 L 27.5 34" stroke="black" strokeLinecap="round" strokeWidth="2.5" />
			</mask>
		</defs>
